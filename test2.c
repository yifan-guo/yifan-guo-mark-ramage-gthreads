...
int main(void)
{
    ...
    printf("Showing the difference between FIFO and RR for IO threads\n");
    gtgo(f_io, 50, FIFO);        //initialize gthread and place it on its ready queuee
    gtgo(f_io, 50, RR);        //initialize gthread and place it on its ready queuee
    gtgo(f, 50, RR);            //initialize gthread and place it on its ready queuee
